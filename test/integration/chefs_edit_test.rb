...
class ChefsEditTest < ActionDispatch::IntegrationTest
  def setup
    @chef = Chef.create!(chefname: "homer1", email: "homer1@example.com",
  ...
  test "accept edit attempt by admin user" do
    ...
    get edit_chef_path(@chef)
    assert_template 'chefs/edit'
    patch chef_path(@chef), params: { chef: { chefname: "homer1", email: "homer1@example.com"} }
    assert_redirected_to @chef
    assert_not flash.empty?
    @chef.reload
    assert_match "homer1", @chef.chefname
    assert_match "homer1@example.com", @chef.email
  end

  test "redirect edit attempt by anoter non-admin user" do
